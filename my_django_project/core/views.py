...
def home(request):
    ...
    {"title": "Training & Placement", "submenu": [
        ...
        {"title": "Placement Procedure", "url": "/training_and_placement/procedure"},
        {"title": "Training Programs & Activities", "url": "/training_and_placement/program"},  
        {"title": "Infrastructure and Facilities", "url": "/training_and_placement/infrastructure"},
        {"title": "Placement Statistics", "url": "/training_and_placement/recruitments"},
        {"title": "Testimonial", "url": "/training_and_placement/testimonial"},
